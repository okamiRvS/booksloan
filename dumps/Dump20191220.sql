...
CREATE TABLE `copia` (
  ...
  CONSTRAINT `FKoa1nwamw7a63we7qw7imxt9rj` FOREIGN KEY (`id`) REFERENCES `libro` (`id`),
...
INSERT INTO `copia` VALUES (123,101,1),(222,102,1),(333,106,1),(335,101,0),(353,103,1),(456,109,1),(789,101,1);
...
INSERT INTO `prestito` VALUES ('2019-12-19 23:25:32','2020-01-19 23:25:32',335,321);
...
CREATE TABLE `scritto` (
  ...
  PRIMARY KEY (`id_autore`,`id`),
  KEY `FKsab13563j7hwipekqh6bqbnac` (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-12-20 10:56:40
